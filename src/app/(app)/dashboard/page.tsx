...
const actions = [{ label: 'Nova entrada', icon: FiArrowDownLeft, tone: 'green' }, { label: 'Nova saída', icon: FiArrowUpRight, tone: 'coral' }, { label: 'Abastecimento', icon: FiTruck, tone: 'blue' }, { label: 'Transferência', icon: FiRepeat, tone: 'lavender' }];
